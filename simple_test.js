...
const TEST_URL = "https://www.techhealth.gov/articles/new-technology-for-Travel";
...
async function runRawDemo() {
  ...
  const tokenizer = await AutoTokenizer.from_pretrained("firefoxrecap/URL-TITLE-classifier");
